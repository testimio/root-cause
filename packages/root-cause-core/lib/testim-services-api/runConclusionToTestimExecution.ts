...
function convertExecution(conclusion: RunConclusionFile, testimUserMetadata: TestimUserMetadata, gitMetadata?: GitMetadata, guidImpl = guid): TestimBackendExecutionInputFormat['execution'] {
...
*  - read them here
*/
function getDetaultTestConfig(conclusion: RunConclusionFile, testimUserMetadata: TestimUserMetadata, gitMetadata?: GitMetadata) {
    return {
        parallel: 1,
        browser: 'chrome',
...
export function runConclusionToTestimExecution(conclusion: RunConclusionFile, testimUserMetadata: TestimUserMetadata, gitMetadata?: GitMetadata, guidImpl = guid): TestimBackendExecutionInputFormat {
    return {
