...
function getIcon(step: StepResult): string {
    switch(step.fnName) {
        ...
        case 'bringToFront': return icons.chrome;
        case 'click': return icons.click;
        case 'hover': return icons.click;
        case 'close': return icons.chrome;
        case 'tap': return icons.click;
        case 'type': return icons.keyboard;
        case 'assertion': return icons.assertion;
        default: return icons.chrome;
    }
}
