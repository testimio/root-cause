...
export const NetworkViewer = React.memo(function NetworkViewer({ harFile, selectedStep }: { harFile: Har, selectedStep: StepResult }) {
    if (selectedStep.endTimestamp === undefined ||
        selectedStep.startTimestamp === undefined
    ) {
        return null;
    }
