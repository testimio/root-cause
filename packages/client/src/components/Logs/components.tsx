            ...
            <div className={styles["console-message"]}>
                <span className={styles["source-code"]}>
                    ...
                    <span className={styles["console-message-anchor"]}>
                        ...
                        <span
                            className={styles["console-message-time"]}
                            title={entry.when.toISOString()}
                        >
                            ({entry.when.toLocaleString()})
                        </span>
                    </span>
                    {!shouldFormatConsole(entry) && (
                        <span className={styles["console-message-text"]}>
                            {getLogMessage(entry)}
                        </span>
                    )}
                    {shouldFormatConsole(entry) && (
                                ...
                                return (
                                    ...
                                    >
                                        {hasPrefix(entry, part) && (
                                            <span className={getPrefixClass(part)}>
                                                {prefixContent(part)}
                                            </span>
                                        )}
                                        ...
                                        {hasPostfix(entry, part) && (
                                            <span className={getPostfixClass(part)}>
                                                {postfixContent(part)}
                                            </span>
                                        )}
                                        &nbsp;
                                    ...
                                    {entry.stackTrace?.map((frame, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td className={styles["stacktrace-separator"]}>
                                                    @
                                                </td>
